pub(crate) fn the_2020th_number_spoken(input: &[usize]) -> usize {
    the_nth_number_spoken(input, 2_020)
}

pub(crate) fn the_30_000_000th_number_spoken(input: &[usize]) -> usize {
...
mod tests {
    ...
    #[test]
    fn part2_examples_3() {
        assert_eq!(the_30_000_000th_number_spoken(&[2, 1, 3]), 3_544_142);
    }
