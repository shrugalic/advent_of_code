...
pub (crate) fn read_file_to_lines(filename: &str) -> Vec<String> {
...
pub (crate) fn read_str_to_lines(s: &'static str) -> Vec<String> {
...
mod tests {
    ...
    fn read_file_to_lines_works() {
        let lines = read_file_to_lines("data/line_reader_test_input.txt");
