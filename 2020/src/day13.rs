pub(crate) fn day13_part1impl(input: &[String]) -> usize {
...
pub(crate) fn day13_part2impl(input: &[String]) -> usize {
...
7,13,x,x,59,x,31,19";
    ...
    #[test]
    fn part1_example() {
        assert_eq!(day13_part1impl(&read_str_to_lines(EXAMPLE1)), 295);
    }
    ...
    #[test]
    fn part2_example_1() {
        assert_eq!(day13_part2impl(&read_str_to_lines(EXAMPLE1)), 1068781);
    }
...
17,x,13,19";
    #[test]
    fn part2_example_2() {
        assert_eq!(day13_part2impl(&read_str_to_lines(EXAMPLE2)), 3417);
    }
...
67,7,59,61";
    #[test]
    fn part2_example_3() {
        assert_eq!(day13_part2impl(&read_str_to_lines(EXAMPLE3)), 754018);
    }
...
67,x,7,59,61";
    #[test]
    fn part2_example_4() {
        assert_eq!(day13_part2impl(&read_str_to_lines(EXAMPLE4)), 779210);
    }
...
67,7,x,59,61";
    #[test]
    fn part2_example_5() {
        assert_eq!(day13_part2impl(&read_str_to_lines(EXAMPLE5)), 1261476);
    }
...
1789,37,47,1889";
    ...
    #[test]
    fn part2_example_6() {
        assert_eq!(day13_part2impl(&read_str_to_lines(EXAMPLE6)), 1202161486);
    }
