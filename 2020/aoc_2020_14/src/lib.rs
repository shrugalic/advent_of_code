...
mem[8] = 0";
    ...
    #[test]
    fn part1_example() {
        assert_eq!(part1impl(&read_str_to_lines(EXAMPLE1)), 165);
    }
...
mem[26] = 1";
    #[test]
    fn part2_example_1() {
        assert_eq!(part2impl(&read_str_to_lines(EXAMPLE2)), 208);
    }

    #[test]
    fn part2() {
        assert_eq!(part2impl(&read_file_to_lines("input.txt"),), 3434009980379);
    }
}
