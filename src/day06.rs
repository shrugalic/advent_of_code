...
pub(crate) struct OrbitCount {
    direct: usize,
    indirect: usize,
}

impl OrbitCount {
    pub(crate) fn from(direct: usize, indirect: usize) -> Self {
        OrbitCount { direct, indirect }
    }
    fn empty() -> Self {
        OrbitCount {
            direct: 0,
...
I)SAN",
    ...
    #[test]
    fn single_orbit() {
        assert_eq!(count_orbits("AAA)BBB"), OrbitCount::from(1, 0));
    }
