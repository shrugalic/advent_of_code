...
pub(crate) struct Point(pub(crate) i64, pub(crate) i64);
#[derive(Debug)]
enum Dir {
    Up,
    Left,
...
pub(crate) struct Robot {
    ...
    loc: Point,
    dir: Dir,
    pub(crate) painted_panels: HashSet<Point>,
    pub(crate) canvas: HashMap<Point, i64>, // 0 or 1
}
impl Robot {
    pub(crate) fn new(input: &mut Vec<i64>, initial_color: Option<i64>) -> Self {
    ...
    fn provide_input(&mut self) -> i64 {
        *self.canvas.get(&self.loc).unwrap()
    }
    fn process(&mut self, input: i64) -> Option<i64> {
        self.icc.process_int_code_with_input(input as i64)
    }
    ...
    fn init_canvas(&mut self, color: Option<i64>) {
...
pub(crate) fn day11_puzzle_input() -> Vec<i64> {
    vec![
        3,
        8,
        1005,
