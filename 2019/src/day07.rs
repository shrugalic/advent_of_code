...
pub(crate) fn max_thrust_in_serial_mode(prg: &Vec<i32>) -> i32 {
...
pub(crate) fn max_thrust_in_feedback_loop_mode(prg: &Vec<i32>) -> i32 {
...
pub(crate) fn day07_puzzle_input() -> Vec<i32> {
    vec![
...
mod tests {
    ...
    #[test]
    fn day7_part2() {
        let mut input = day07_puzzle_input();
